...
public class ModItems
{
    ...
    public static final RegistryObject<DynamicTool> DYNAMIC_PICKAXE = Registration.ITEMS.register("dynamic_pickaxe", () -> new DynamicTool(ToolType.PICKAXE));
    public static final RegistryObject<DynamicTool> DYNAMIC_SHOVEL = Registration.ITEMS.register("dynamic_shovel", () -> new DynamicTool(ToolType.SHOVEL));
