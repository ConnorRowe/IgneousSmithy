...
class SideProxy implements IProxy
{
    ...
    static class Client extends SideProxy
    {
        ...
        public static void registerTextures(final TextureStitchEvent.Pre evt)
        {
            ...
            final String[] knownMaterialTextures = new String[]{"glint", "shiny", "dull", "cactus", "bone"};
            ...
            if (map.getTextureLocation() == PlayerContainer.LOCATION_BLOCKS_TEXTURE)
            {
                for (String t : knownMaterialTextures)
                {
                    ...
                    evt.addSprite(new ResourceLocation(IgneousSmithy.MODID, "item/tool/hatchet_head_" + t));
                    evt.addSprite(new ResourceLocation(IgneousSmithy.MODID, "item/tool/hatchet_bind_" + t));
                    evt.addSprite(new ResourceLocation(IgneousSmithy.MODID, "item/tool/sword_head_" + t));
                    evt.addSprite(new ResourceLocation(IgneousSmithy.MODID, "item/tool/sword_bind_" + t));
                ...
                for (ToolType t : ToolType.ALL_TOOLS)
                {
                    ...
                    evt.addSprite(new ResourceLocation(IgneousSmithy.MODID, "item/tool/" + id + "_silk"));
                }
